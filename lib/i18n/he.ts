export const he = {
  ...
  home: {
    hero: {
      title: "מה הכיוון המקצועי שבאמת מתאים לך?",
      subtitle: "שאלה שמלווה אלפי משוחררים ומשוחררות מהצבא מדי שנה",
      description: "CareerOS זה סוכן AI שעוזר לך למצוא עבודות ומסלולי קריירה שמתאימים לאישיות ולכישורים שלך — לא על פי מה שאחרים חושבים, אלא על פי מה שאתה/את באמת אוהב/ת, יודע/ת, ורוצה/רוצה.",
      cta: "בוא נתחיל",
    },
    howItWorks: {
      title: "איך זה עובד?",
      steps: [
        {
          number: "1",
          title: "שיחה",
          description: "כמו שמדברים עם חבר טוב — אנחנו שואלים על תחומי עניין, כישורים, ערכים ואילוצים",
        },
        {
          number: "2",
          title: "התאמה",
          description: "המנוע שלנו משווה את הפרופיל שלך לעשרות מקצועות בשוק העבודה הישראלי",
        },
        {
          number: "3",
          title: "3 מסלולים",
          description: "מקבל/ת דוח PDF עם 3 מסלולים: בטוח, צמיחה וג׳וקר — בעברית, מותאם אישית",
        },
      ],
    },
    features: {
      ...
      items: [
        {
          icon: "🎓",
          title: "משוחרר/ת מהצבא",
          description: "אחרי השירות, לפני עבודה או לימודים — רגע מצוין לבדוק מה באמת מתאים",
        },
        {
          icon: "🤔",
          title: "תקוע/ה בהתלבטות",
          description: "לומדים משהו שלא מרגיש נכון? עובדים במשהו שלא מספק? בוא נבדוק",
        },
        {
          icon: "🔄",
          title: "רוצה להחליף כיוון",
          description: "לפעמים כדאי לשנות מסלול. המערכת תעזור לך לזהות אפשרויות",
        },
      ],
    },
    cta: {
      title: "מוכן/ה להתחיל?",
      description: "זה לוקח בערך 15–20 דקות. אין צורך להירשם מראש.",
      button: "בוא נדבר",
    },
    nav: {
      assessments: "שאלונים",
      cv: "קורות חיים",
      recommendations: "ההמלצות שלי",
      interview: "סימולטור ראיון",
    },
  },
  disclaimer: {
