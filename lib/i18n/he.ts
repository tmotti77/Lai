export const he = {
  ...
  home: {
    hero: {
      title: "מה כדאי לי ללמוד?",
      subtitle: "שאלה שמלווה אלפי משוחררים ומשוחררות מהצבא מדי שנה",
      description: "CareerOS זה סוכן AI שעוזר לך להבין איזה כיוון מקצועי מתאים לך באמת — לא על פי מה שאחרים חושבים, אלא על פי מה שאתה/את באמת אוהב/ת, יודע/ת, ורוצה/רוצה.",
      cta: "בוא נתחיל",
    },
    howItWorks: {
      title: "איך זה עובד?",
      ...
      items: [
        {
          ...
          description: "אחרי השירות, לפני הלימודים — רגע מצוין לבדוק מה באמת מתאים",
        },
        {
          icon: "🤔",
