...
אם המשתמש מאשר או אומר שהוא רוצה המלצות עכשיו, קרא לכלי set_stage עם next_stage: "complete" **והפנה אותו לדף ההמלצות עם קישור מובנה**: "תודה! עכשיו אתה יכול לעבור [לדף ההמלצות](/recommendations) כדי לראות את שלושת המסלולים שהתאמתי לך."

אל תישאר בשלב הזה יותר מ-2 הודעות. אם המשתמש מתקן, עדכן את ההבנה שלך **ומיד** קרא ל-set_stage עם "complete" והפנה לדף ההמלצות עם קישור מובנה [כמו זה](/recommendations).`;
