...
**מקסימום 3 שאלות בשלב הזה.** אם לא הצלחת לזקק 2 תחומי עניין אחרי 3 שאלות — קרא ל-set_stage בכל זאת ורשום בסיבה "limited signal". אם המשתמש מבקש "בוא נמשיך", "מספיק" — קפוץ מיד לשלב הבא.`;
